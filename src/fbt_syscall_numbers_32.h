/**
 * @file fbt_syscall_numbers_32.h
 * This file lists the 32 bit linux signal numbers.
 *
 ...
 * MA  02110-1301, USA.
 */
#ifndef FBT_SYSCALL_NUMBERS_32_H_
#define FBT_SYSCALL_NUMBERS_32_H_

#define I386_NR_SYSCALLS_32 341  /* total # of system calls */
...
#define SYS32_unused1      222
#define SYS32_unused2      223
...
#define SYS32_timer_settime  (SYS32_timer_create+1)
#define SYS32_timer_gettime  (SYS32_timer_create+2)
#define SYS32_timer_getoverrun   (SYS32_timer_create+3)
#define SYS32_timer_delete   (SYS32_timer_create+4)
#define SYS32_clock_settime  (SYS32_timer_create+5)
#define SYS32_clock_gettime  (SYS32_timer_create+6)
#define SYS32_clock_getres   (SYS32_timer_create+7)
#define SYS32_clock_nanosleep    (SYS32_timer_create+8)
...
#define SYS32_mq_unlink      (SYS32_mq_open+1)
#define SYS32_mq_timedsend   (SYS32_mq_open+2)
#define SYS32_mq_timedreceive    (SYS32_mq_open+3)
#define SYS32_mq_notify      (SYS32_mq_open+4)
#define SYS32_mq_getsetattr  (SYS32_mq_open+5)
...
#endif /* FBT_SYSCALL_NUMBERS_32_H_ */
